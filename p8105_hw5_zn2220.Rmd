...
There is dramatic variation across cities. Some cities, like Richmond, VA, have unsolved rates below 30%, while others, like Chicago, IL, have rates exceeding 70%. The error bars represent our uncertainty in these estimates. Overall, cities with fewer homicide cases (smaller sample sizes) tend to have wider confidence intervals—for example, several smaller and mid-sized cities in the plot show longer error bars, indicating greater uncertainty in their estimated proportions of unsolved cases. In contrast, cities with larger numbers of cases, such as Chicago, IL, or Baltimore, MD, have much narrower confidence intervals, meaning their estimates are more stable and reliable.